...
const agents=[
 ...
 ['RETARGET CONTRACT','retarget-v016-agent.js'],
 ['LOCOMOTION / IDLE / HIT','locomotion-v016-agent.js'],
 ['CONTROL MAP A/D Q/E','control-map-v016-agent.js'],
 ['SMOOTH SKIN','smooth-skin-v016-agent.js'],
 ['MELEE UAL2','melee-ual2-v016-agent.js'],
 ['CASTER + ARCHER PRESERVATION','caster-archer-preserve-v016-agent.js'],
 ['SIMULATION AUTHORITY','authority-v016-agent.js'],
...
console.log('PROJECT ARENA v0.16 · UAL2 RETARGET LOCOMOTION · SPECIALIZED AUDIT FAN-OUT\n');
