...
const TOMAS = [
  ...
  { name: '13c-power-cast-windup', wait: 220,
    setup: `var c=window.__ctx(); c.p.combatMode=true; c.p.cast={startTime:c.w.time-0.001, duration:0.4, movable:false};` },
  { name: '13d-power-cast-windup-late', wait: 150, setup: `` },
  { name: '14-power-c', wait: 90,
    setup: `var c=window.__ctx(); c.p.cast=null; c.CB.triggerAttack(c.handle, c.archetype, true, null, 'heavy', 0, null, 0);` },
  { name: '15-power-c-follow', wait: 500, setup: `` },
  { name: '15b-kick', wait: 60,
    setup: `var c=window.__ctx(); c.CB.triggerAttack(c.handle, c.archetype, true, null, 'kick', 0, null, 0);` },
  { name: '15c-kick-follow', wait: 400, setup: `` },
