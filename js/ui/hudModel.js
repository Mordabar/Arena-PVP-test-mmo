...
Arena.define('ui/hudModel', ['data/effects', 'data/abilities'], function (Arena) {
  ...
  M.FAILURES = {
    ...
    badClass: { title: 'PODER DE OTRA SUBCLASE', mark: '◇', tone: 'state',
      hint: function () { return 'Abre el libro de poderes de tu subclase y asigna una habilidad compatible.'; } },
    passive: { title: 'PODER PASIVO', mark: '∞', tone: 'state',
      hint: function () { return 'Los pasivos se aplican automáticamente y no ocupan una ranura activa.'; } },
    ...
    noAoE: { title: 'ÁREAS BLOQUEADAS', mark: '◉', tone: 'state',
      hint: function () { return 'Tu estado actual impide lanzar poderes de área; usa un poder dirigido o espera a que termine.'; } },
